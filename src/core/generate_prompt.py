    ...
    def common_prompt(last_chat, latest_10, previous_history):
        ...
        sys_message = SystemMessage(
            content=(
                ...
                "  Add mortgage_balance + property_equity, set the result as the new property_equity.\n"
                "  Then say exactly: 'So the total property value comes to [sum]. Does that look correct?'\n"
                "  If user confirms: proceed. If user says no: ask them to provide the correct total and set that as property_equity.\n\n"

                "  CASE B — mortgage is LESS than or EQUAL to property_equity:\n"
                "  Add mortgage_balance + property_equity, show the user the total.\n"
                "  Then say exactly: 'So the total property value comes to [sum]. Does that look correct?'\n"
                "  If user confirms: proceed. If user says no: ask them to provide the correct total and set that as property_equity.\n\n"
                ...
                "- After confirmation, continue to the next missing net_position field.\n\n"
                ...
                "6. mortgage_balance — Do you have any outstanding mortgage balance on that property?"
                    "If non-zero: If mortgage is less than equity, sum the equity and mortgage, then take confirmation about the total. Also ask if it is wrong, let them provide the correct value."
                    "If non-zero: If mortgage is greater than equity (point 4. property_equity), sum the mortgage and property_equity, ask the user to confirm the total price, and set that value on property_equity."
               ...
               "Initially, also ask about others in the category (e.g. 'other assets' or 'other liabilities') to capture anything not covered by the specific fields."
                ...
                "- When the user provides a value for 'mortgage_balance':"
                    "If mortgage is greater than equity (point 4. property_equity), sum the mortgage and property_equity, ask the user to confirm the total price, and set that value on property_equity."
                    "If mortgage is less than equity, sum the equity and mortgage, then take confirmation about the total. Also ask if it is wrong, let them provide the correct value."
