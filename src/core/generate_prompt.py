    ...
    def common_prompt(last_chat, latest_10, previous_history):
        ...
        sys_message = SystemMessage(
            content=(
                ...
                # "first.\n\n"
                "20. MORTGAGE BALANCE FOLLOW-UP RULE (fires immediately after user gives a non-zero mortgage_balance):\n"
                "- Do NOT question or second-guess the number the user gave. Accept it as the mortgage balance.\n"
                "- Compare mortgage_balance to property_equity:\n\n"

                "  CASE A — mortgage is GREATER than property_equity:\n"
                "  Tell the user that the mortgage balance is greater than the property value previously provided.\n"
                "  Then ask exactly: 'What is the property's full current market value?'\n"
                "  Replace property_equity with the new value provided by the user.\n"
                "  Do NOT calculate or assume any values.\n\n"

                "  CASE B — mortgage is LESS than or EQUAL to property_equity:\n"
                "  Say exactly: 'Just to confirm, your property's current market value is [property_equity] and your outstanding mortgage balance is [mortgage_balance]. Is that correct?'\n"
                "  If user confirms: proceed.\n"
                "  If user corrects either value: update the corrected value(s) and confirm again.\n\n"

                "- NEVER ask the user to clarify what their number means — always treat the number as the mortgage balance.\n"
                "- NEVER ask 'is that the mortgage or the property price?' — this question is forbidden.\n"
                "- NEVER add mortgage_balance and property_equity together.\n"
                "- After confirmation (or after collecting the updated property value), continue to the next missing net_position field.\n\n"
                ...
                "6. mortgage_balance — Do you have any outstanding mortgage balance on that property?\n"
                    "If non-zero:\n"
                    "  If mortgage_balance is greater than property_equity (point 4. property_equity), tell the user the mortgage balance is greater than the previously provided property value, then ask again for the property's full current market value and update property_equity.\n"
                    "  If mortgage_balance is less than or equal to property_equity (point 4. property_equity), confirm both the property value and mortgage balance with the user.\n"
                ...
                "7. car_or_boat_loan — Do you have any loans for vehicles, equipment, boat, or other assets?"
                    "If non-zero AND the original-price question was NOT already asked, OR the user did not provide a price under other_assets, then ask for the original price and set it on other_assets."
                    "If the user has already provided any value or number, do not repeat the question."
               ...
               "Initially, also ask about others in the category (e.g. 'other assets' or 'other liabilities') to capture anything not covered by the specific fields."
                ...
                "- When the user provides a value for 'mortgage_balance':\n"
                    "  If mortgage_balance is greater than property_equity (point 4. property_equity), tell the user the mortgage balance is greater than the previously provided property value, then ask again for the property's full current market value and update property_equity.\n"
                    "  If mortgage_balance is less than or equal to property_equity (point 4. property_equity), confirm both the property value and mortgage balance with the user, and keep the confirmed property_equity value.\n"

                "- If the user has any loan under 'car_or_boat_loan', immediately follow up by asking:"
                    "'What was the original purchase price of that vehicle or asset?'"
                "- Store the original price by ADDING it to the existing 'other_assets' value."
                "- Example: If other_assets was 1000 and the user says the original price was 200000, set other_assets = 201000."
